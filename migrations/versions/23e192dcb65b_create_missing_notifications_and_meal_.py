...
Revision ID: 23e192dcb65b
Revises: d3ff452c4ee3
Create Date: 2025-11-28 22:07:24.435657
"""
...
revision: str = '23e192dcb65b'
down_revision: Union[str, Sequence[str], None] = 'd3ff452c4ee3'
...
def upgrade() -> None:
    ...
    # ---- IMPORTANT: ENUM already exists, so do NOT recreate it ----
    ...
    # ---- Create Meal Share Requests Table ----
    op.create_table(
        'meal_share_requests',
