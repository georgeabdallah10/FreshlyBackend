...
from sqlalchemy import Integer, DateTime, Date, ForeignKey, Numeric, func, String, Column
...
class PantryItem(Base):
    ...
    family_id: Mapped[int] = mapped_column(ForeignKey("families.id", ondelete="CASCADE"), nullable=True)
